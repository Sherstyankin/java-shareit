...
public interface BookingService {
    ...
    List<ResponseBookingDto> findAllBookingByUserId(Long userId, BookingState state);

    List<ResponseBookingDto> findAllBookingByOwnerItems(Long userId, BookingState state);
}
